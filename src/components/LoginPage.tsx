    ...
    <ThemeProvider defaultTheme="dark" storageKey="python-quest-theme">
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white p-4 selection:bg-cyan-500 selection:text-white">
        <header className="text-center mb-8 animate-fadeIn">
          <div className="inline-block p-3 bg-gradient-to-r from-cyan-500 to-green-500 rounded-xl mb-4">
            <KeyRound size={48} className="text-white" />
          </div>
          <h1 className="text-5xl font-bold bg-gradient-to-r from-cyan-400 to-green-400 bg-clip-text text-transparent mb-2">
            Welcome to Python Quest
          </h1>
          <p className="text-xl text-gray-300">Your Secure, Self-Custody Learning Journey.</p>
        </header>
        ...
        <main className="w-full max-w-md animate-slideUp">
          <Tabs defaultValue="login" className="w-full">
            <TabsList className="grid w-full grid-cols-3 bg-gray-800 border border-gray-700">
              ...
              <TabsTrigger value="guest" className="data-[state=active]:bg-purple-600 data-[state=active]:text-white">
            ...
            <TabsContent value="login">
              <Card className="bg-gray-800/70 border-cyan-500/30 backdrop-blur-sm">
                <CardHeader>
                ...
                <form onSubmit={handleLoginWithKeystore}>
                  <CardContent className="space-y-4">
                    <div className="space-y-1">
                      <label htmlFor="keystoreFile" className="text-sm font-medium text-gray-300">Keystore File</label>
                      <Input
                        id="keystoreFile"
                        type="file"
                        accept=".json"
                        onChange={handleFileChange}
                        className="bg-gray-700 border-gray-600 text-white file:text-cyan-400 file:font-semibold file:mr-2 file:px-3 file:py-1.5 file:rounded-md file:border-0 file:bg-cyan-500/20 hover:file:bg-cyan-500/30"
                        disabled={isLoading}
                      />
                    </div>
                    <div className="space-y-1">
                  ...
                  <CardFooter>
                    <Button type="submit" className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white" disabled={isLoading}>
            ...
            <TabsContent value="create">
              <Card className="bg-gray-800/70 border-green-500/30 backdrop-blur-sm">
                <CardHeader>
                ...
                <form onSubmit={handleCreateAccount}>
                  ...
                  <CardFooter>
                    <Button type="submit" className="w-full bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white" disabled={isLoading}>
            ...
            <TabsContent value="guest">
              <Card className="bg-gray-800/70 border-purple-500/30 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription className="text-gray-400">
                    ...
                    You can create a secure keystore account later to save your progress permanently.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-gray-400 mb-4">
                    Click below to start learning immediately. If you enjoy Python Quest, you can create an account at any time from the main dashboard to secure your progress.
                  </p>
                </CardContent>
                <CardFooter>
                  <Button onClick={handleGuestMode} className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white" disabled={isLoading}>
        ...
        <footer className="text-center mt-12 animate-fadeIn animation-delay-500">
          ...
          <p className="text-xs text-gray-500 max-w-md mx-auto">
            ...
            <a href="https://github.com/Juniorduc44/pathToPython/blob/factorAI/keyStore_logins_00.md" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline ml-1">Learn more</a>.
          </p>
        </footer>
      </div>
    </ThemeProvider>
